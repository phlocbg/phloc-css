...
public final class CSSRectTest
{
  ...
  public void testAPI ()
  {
    ...
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (aRect, new CSSRect ("2", "2", "0", "4"));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (aRect, new CSSRect ("3", "2", "3", "0"));
