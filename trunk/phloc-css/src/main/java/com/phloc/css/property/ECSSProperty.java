...
{
  ALIGN_CONTENT ("align-content", ECSSVersion.CSS30, ECSSSpecification.CSS3_FLEXBOX),
  ALIGN_ITEMS ("align-items", ECSSVersion.CSS30, ECSSSpecification.CSS3_FLEXBOX),
  ALIGN_SELF ("align-self", ECSSVersion.CSS30, ECSSSpecification.CSS3_FLEXBOX),
  ...
  BREAK_AFTER ("break-after", ECSSVersion.CSS30, ECSSSpecification.CSS3_MULTICOL),
  BREAK_BEFORE ("break-before", ECSSVersion.CSS30, ECSSSpecification.CSS3_MULTICOL),
  BREAK_INSIDE ("break-inside", ECSSVersion.CSS30, ECSSSpecification.CSS3_MULTICOL),
  ...
  JUSITFY_CONTENT ("justify-content", ECSSVersion.CSS30, ECSSSpecification.CSS3_FLEXBOX),
